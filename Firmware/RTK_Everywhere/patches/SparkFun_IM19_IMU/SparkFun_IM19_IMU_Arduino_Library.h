...
const uint8_t offsetMemsTimestamp = 4;
const uint8_t offsetMemsAccelX = 12;
const uint8_t offsetMemsAccelY = 16;
const uint8_t offsetMemsAccelZ = 20;
const uint8_t offsetMemsGyroX = 24;
const uint8_t offsetMemsGyroY = 28;
const uint8_t offsetMemsGyroZ = 32;
...
class IM19
{
  private:
    ...
    unsigned long lastUpdateMems = 0;
